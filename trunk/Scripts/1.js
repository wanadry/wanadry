...
var dp = {
	sh :
	{
		...
		Brushes	: {},
		Strings : {
			AboutDialog : '<html><head><title>About...</title></head><body class="dp-about"><table cellspacing="0"><tr><td class="copy"><p class="title">Valent Huba</div><div class="para">Version: {V}</p><p><a href="http://vhuba.blogspot.com/2011/11/membuat-view-plain-print-pada-postingan.html" target="_blank" title="Cara Membuat Syntax Seperti Ini">Membuat View Plain Print ? seperti ini,pada postingan blog</a></p>&copy;2011-2012 BaseCamp Setiakawan.</td></tr><tr><td class="footer"><input type="button" class="close" value="OK" onClick="window.close()"/></td></tr></table></body></html>'
		},
		ClipboardSwf : null,
		Version : '1.5.2'
	}
