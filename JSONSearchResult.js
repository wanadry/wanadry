...
function showResult(json) {
  ...
  skeleton += '<a title="Close" style="display:block;position:absolute;top:10px;right:12px;line-height:normal;text-decoration:none;color: #f00;background-color: #000;border-radius: 10px;
padding: 0px 4px 0px 4px;font-size:150%;" href="#close" onclick="resultContainer.style.display=\'none\';return false;">&times;</a><ol>';
	if (entry === "") {
